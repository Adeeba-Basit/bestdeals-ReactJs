            ...
            <div className="container-fluid my-2">
                <div className="row">
                    ...
                    <div className="col-md-10">
                        <h5 className='bg-primary text-light text-center p-3 rounded'>Admin Home</h5>
                        <div className="row">
                            <div className="col-md-4">
                                {
                                    user.pic ?
                                        <img src={`/assets/images/${user.pic}`} height="240px" width="100%" /> :
                                        <img src={`/assets/images/noimage.jpg`} height="240px" width="100%" />
                                }
                            </div>
