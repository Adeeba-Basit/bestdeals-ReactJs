            ...
            <div className="container-fluid my-2">
                <div className="row">
                    ...
                    <div className="col-md-10">
                        <h5 className='bg-primary text-light text-center p-3 rounded'>Brand <Link to="/admin-add-brand"><i className='fa fa-plus text-light float-right'></i></Link></h5>
                                    ...
                                    </tr>
                                    {
                                        data.map((item,index)=>{
                                            return <tr key={index}>
                                                <td>{item.id}</td>
                                                <td>{item.name}</td>
                                                <td><img src={`/assets/brands/${item.pic}`} height="50px" width="50px"/></td>
