            ...
            <div className="container-fluid my-2">
                <div className="row">
                    ...
                    <div className="col-md-10">
                        <h5 className='bg-primary text-light text-center p-3 rounded'>Product <Link to="/admin-add-product"><i className='fa fa-plus text-light float-right'></i></Link></h5>
                                            ...
                                            return <tr key={index}>
                                                ...
                                                <td>
                                                    <Link to={`/assets/images/${item.pic2}`} rel="noreferrer" target='_blank'>
                                                        <img src={`/assets/images/${item.pic2}`} height="60px" width="100px" className='rounded' />
                                                    </Link>
                                                </td>
                                                <td>
                                                    <Link to={`/assets/images/${item.pic3}`} rel="noreferrer" target='_blank'>
                                                        <img src={`/assets/images/${item.pic3}`} height="60px" width="100px" className='rounded' />
                                                    </Link>
                                                </td>
                                                <td>
                                                    <Link to={`/assets/images/${item.pic4}`} rel="noreferrer" target='_blank'>
                                                        <img src={`/assets/images/${item.pic4}`} height="60px" width="100px" className='rounded' />
                                                    </Link>
                                                </td>
