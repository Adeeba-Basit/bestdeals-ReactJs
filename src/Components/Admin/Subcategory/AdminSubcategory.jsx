            ...
            <div className="container-fluid my-2">
                <div className="row">
                    ...
                    <div className="col-md-10">
                        <h5 className='bg-primary text-light text-center p-3 rounded'>Subcategory <Link to="/admin-add-subcategory"><i className='fa fa-plus text-light float-right'></i></Link></h5>
