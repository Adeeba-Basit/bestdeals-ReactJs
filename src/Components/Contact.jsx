                        ...
                        <div className="col-lg-7 mb-5 mb-lg-0">
                            ...
                            <div className="">
                                <form onSubmit={postData}>
                                    ...
                                    <p><textarea name="message" required id="message" onChange={getInputData} className='form-control mb-3' rows="5" placeholder="Message" value={data.message}></textarea></p>
                                    <div className='mb-3'>
                        ...
                        <div className="col-lg-5">
                            <div className="contact-form-wrap">
                                ...
                                <div className="contact-form-box">
                                    ...
                                    <p><i className='fa fa-phone'></i>: <a href="tel:+91-9193470877">+91-9193470877</a> <br /> <i className='fa fa-envelope'></i>: <a href="mailto:adeebabasit@gmail.com">adeebabasit@gmail.com</a> </p>
                                </div>
                            </div>
                        </div>
                    </div>
